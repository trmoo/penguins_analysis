...
const DICT = [
  ...
  ['1', '표.head(n) · 표.tail(n)', '앞(뒤)의 n줄을 본다. n 을 비우면 5줄', 'penguins.head(3)'],
  ['1', '표.info()', '줄 수·열 이름·빈칸 아닌 값의 수·자료형을 본다', 'penguins.info()'],
  ['1', '표.describe()', '숫자 열의 개수·평균·표준편차·최솟값·사분위수·최댓값', 'penguins.describe()'],
  ['1', '표.shape', '(행 수, 열 수). 괄호 없이 쓴다', 'penguins.shape'],
  ['1', "표['열'].value_counts()", '값마다 몇 번 나오는지 센다', "penguins['species'].value_counts()"],
  ...
  ['2', '표.loc[번호]', '줄 번호(이름표)로 한 줄을 꺼낸다', 'penguins.loc[19]'],
